...
public abstract class GUI {
	...
	/**
	 * Is called whenever the search box is updated. Use getSearchBox to getALL the
	...
	private void initialise() {
		...
		load.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				...
				if (fileChooser.showOpenDialog(frame) == JFileChooser.APPROVE_OPTION) {
					// getALL the files in the selected directory and match them to
					// the files we need.
		 ...
		 * JScrollPane to getALL scroll bars when necessary.
		 */
